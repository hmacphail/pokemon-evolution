let generations       = require('./controllers/generations');
let pokemon           = require('./controllers/pokemon');
let pokemonStats	  = require('./controllers/pokemonStats');
let evolutions        = require('./controllers/evolutions');
let types             = require('./controllers/types');
let effectiveness     = require('./controllers/effectiveness');
let abilities         = require('./controllers/abilities');
let abilitysets       = require('./controllers/abilitysets');
let moves             = require('./controllers/moves');
let zMoves			  = require('./controllers/zMoves');
let moveFlags		  = require('./controllers/moveFlags');
let learnsets         = require('./controllers/learnsets');
let items             = require('./controllers/items');
let pokemonTypes      = require('./controllers/pokemonTypes');
let games             = require('./controllers/games');
let pokemonLearnsets  = require('./controllers/pokemonLearnsets');
